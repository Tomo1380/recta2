        ...
        $articles = [
            [
                ...
                'body_paragraphs' => [
                    ...
                    ['h2', 'まずは体験入店してみる'],
                    ['p', 'どちらが自分に合うかは正直、実際に入ってみないと分かりません。Recta では体験確約のお店も多数掲載しているので、気になる業態を 2〜3 件回ってから決めるのが失敗しないコツです。'],
                ],
            ],
            [
                ...
                'body_paragraphs' => [
                    ...
                    ['h2', '上京までの 4 ステップ'],
                    ['p', '① オンライン面接 (LINE 通話 / Zoom、15-30 分)。② 体験入店 (体験確約 / 交通費全額負担あり)。③ 住居サポート (家具家電付きシェアハウス、敷金礼金ゼロ物件)。④ 本入店 (引っ越し補助 + 初月家賃 + 入店祝い金)。'],
                    ['h2', 'よくある不安への答え'],
