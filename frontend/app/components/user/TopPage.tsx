...
export default function TopPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f7f6f3" }}>
      ...
      {/* LINE公式 友だち追加 CTA                                           */}
      {/* ================================================================= */}
      <section className="px-4 py-10" style={{ backgroundColor: "white" }}>
        <div className="mx-auto max-w-6xl">
          <div
            className="relative overflow-hidden rounded-[18px] px-6 py-8 text-center"
            style={{
          ...
          >
            ...
            />
            <div
              className="absolute -bottom-6 -left-6 size-24 rounded-full"
            ...
            <div className="relative">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3 text-sm font-bold transition-opacity hover:opacity-90"
                style={{ color: "#06C755" }}
              >
                <UserPlus size={16} />
                友だち追加する
