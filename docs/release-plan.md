...
| Gemini 3 Flash (Vertex SFT) | 要見積（per node-hour） | $0.50 | $3.00 | 訓練価格不透明 |
| Gemini 3.1 Flash-Lite | チューニング未対応(2026/05時点) | $0.10 | $0.40 | 現Agentモードで使用中 |
...
| Gemini 3 Flash (FT) | $0.005×0.50 + $0.008×3.00 = **$0.0265（約4.0円）** |
| Gemini 3.1 Flash-Lite (現状) | $0.005×0.10 + $0.008×0.40 = **$0.0037（約0.6円）** |
